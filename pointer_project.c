...
//물고기가 6마리가 있다.
//어항에 살고 있는데 사막이라 너무 더워서 너무 건조해 물이 빨리 증발한다.
//물이 다 증발하기 전에 어항에 물을 줘서 물고기를 살려야한다.
...
int main() {
	...
	while (1) { //무한 반복, 1=참, 0=거짓
		...
		if (checkFishAlive() == 0) {
			...
			//최소 한마리 이상의 물고기는 살아있다.
			printf("물고기가 아직 살아있어요!\n");
		}
		prevElapsedTime = totalElapsedTime;
		//물을 준 시간: 10초-> 15초(prev:15-10=5초)-> 25초(25-15=10이 되야하므로 prev에 total시간을 대입)
